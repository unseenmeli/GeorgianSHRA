...
urlpatterns = [
    ...
    path('first-congress-abstract/', views.first_congress_abstract, name='first_congress_abstract'),
    ...
    path('news44/', views.news44, name='news44'),
    path('news45/', views.news45, name='news45'),
    path('news46/', views.news46, name='news46'),
